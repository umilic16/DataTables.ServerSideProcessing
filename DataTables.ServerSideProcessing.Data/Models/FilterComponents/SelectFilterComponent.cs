...
/// </summary>
public record SelectFilterComponent<V, T>(string tableName, string columnName, Dictionary<V, T> availableValues)
...
/// </summary>
public sealed record SelectFilterComponent(string tableName, string columnName, Dictionary<string, string> availableValues)
    : SelectFilterComponent<string, string>(tableName, columnName, availableValues);
